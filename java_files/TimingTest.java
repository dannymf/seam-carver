...
public class TimingTest {
    ...
    public TimingTest(Picture picture) {
        if (picture == null)
    ...
    public double energy(int x, int y) {
        ...
        int g4 = (yDown >> 8) & 0xFF;
        int b4 = (yDown >> 0) & 0xFF;
        int gradY = ((r3 - r4) * (r3 - r4) + (g3 - g4) * (g3 - g4) + (b3 - b4) * (b3 - b4));
    ...
    public static void main(String[] args) {
        ...
        TimingTest test = new TimingTest(picture);
        StdOut.println("Dimensions: " + test.width() + " x " + test.height());
